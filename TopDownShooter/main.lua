-- i just want my life to be about love and not the sorrow that love brings
...
function playerMouseAngle()
    return math.atan2(player.y - love.mouse.getY(), player.x - love.mouse.getX()) + math.pi -- (or just switch the player and mouse x and y in this function)
end
...
function spawnZombie()
    ...
    elseif side == 2 then --right side of screen
        ...
        zombie.y = math.random(0, love.graphics.getHeight())
    elseif side == 3 then --top of screen
        zombie.x = math.random(0, love.graphics.getHeight())
        zombie.y = -30
    elseif side == 4 then --bottom of screen
