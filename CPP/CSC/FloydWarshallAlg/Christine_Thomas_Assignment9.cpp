...
{
    int shortestDistance[VERTICES][VERTICES], i, j, k;
    ...
    printFinalMatrix(outputFile, shortestDistance);
}
...
int main()
{
    ...
    std::ofstream theFile("C:\\Users\\chris\\Documents\\WSU Computer Science\\FloydWarshallAlg\\Assignment9_Output.txt");
